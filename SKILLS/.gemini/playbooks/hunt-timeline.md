# Playbook: Timeline Analysis

## Objective
Extract and analyze complete event timelines from Cisco Secure Endpoints to understand the full sequence of activity -- file executions, network connections, threat detections, and process activity.
...
grep -E '\.doc|\.xls|\.pdf|\.ppt' timelines/*.txt  # Document staging
```
...
## Follow-Up Playbooks
- Suspicious hashes -> `playbooks/hunt-hashes.md`
- Anomalous connections -> `playbooks/hunt-network.md`
- Lateral movement suspected -> `playbooks/hunt-lateral-movement.md`
