# Playbook: Persistence Mechanism Detection
...
## Follow-Up Playbooks
- Persistence found -> `playbooks/hunt-timeline.md` on affected endpoints
- Tools used -> `playbooks/hunt-hashes.md`
- Remote persistence creation -> `playbooks/hunt-lateral-movement.md`
