...
## Objective
Detect credential dumping tools, LSASS access attempts, and credential harvesting activity. Composite hunt combining hash-based detection with keyword searches.
...
## Follow-Up
- Creds stolen -> `instructions/hunt-lateral-movement.md`
- Specific endpoints compromised -> `instructions/hunt-timeline.md`
- C2 channels found -> `instructions/hunt-network.md`
